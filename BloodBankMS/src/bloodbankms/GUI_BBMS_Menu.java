 ...
 * @author Asus
 */
public class GUI_BBMS_Menu extends javax.swing.JFrame {

    /**
     * Creates new form GUI_BBMS_Menu
     */
    public GUI_BBMS_Menu() {
        initComponents();
    }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_BBMS_Menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_BBMS_Menu().setVisible(true);
            }
        });
    }
